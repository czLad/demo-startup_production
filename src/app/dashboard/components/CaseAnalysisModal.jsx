...
import { X, AlertTriangle, Flag, FileText, Loader2 } from "lucide-react";

export default function CaseAnalysisModal({ isOpen, onClose, data }) {
  if (!isOpen) return null; // Only hide if modal isn't open
        ...
        >
          ...
          >
            ...
            {!data ? (
              ...
              // ✅ Render actual content once data exists
